...
from portalbrasil.devsite import CMF_DEPENDENCIES_PROFILE
from portalbrasil.devsite import DEFAULT_PROFILE
from portalbrasil.devsite import DEPENDENCIES_PROFILE
...
class LocalAddonList:
    addon_list: AddonList = AddonList([
        ...
        Addon(profile_id="portalbrasil.devsite:base"),
        Addon(profile_id="portalbrasil.devsite:cmfdependencies"),
        Addon(profile_id="portalbrasil.devsite:dependencies"),
    ])
