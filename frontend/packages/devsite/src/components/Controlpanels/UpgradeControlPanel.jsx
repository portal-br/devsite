...
import VersionOverview from '@portalbrasil/devsite/components/Controlpanels/VersionOverview';
...
const messages = defineMessages({
  ...
  upgradeInformation: {
    id: 'Upgrade portalbrasil.devsite',
    defaultMessage: 'Upgrade portalbrasil.devsite',
  },
  upgrade: {
